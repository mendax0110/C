...
/*fill the rtc date*/
static void fill_rtcdate(sturct rtcdate *r)
{
...
/*qemu seems to use 24-hour and the values are in BCD encoded*/
void cmostime(struct rtcdate *r)
{
    ...
    /*backup raw values since BCD conversion removes PM bit form hour*/
    t2 = t1;
