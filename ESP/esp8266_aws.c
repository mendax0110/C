...
/*find the awsEndpoint in the AWS Console
 *chosse which to interact, its mostly the HTTPS Rest enpoint
 */
const char* awsEndpoint "xxxxxxxxx.iot.us-west-2.amazonaws.com";

/*put in the pem cert*/
static const char certificatePemCrt[] PROGREM = R"EOF(
-----BEGIN CERTIFICATE-----
...
/*put in the private pem key*/
static const char privatePemKey[] PROGREM = R"EOF(
...
/*this it the AWS IoT CA Cert from the following URL:
 *https://docs.aws.amazon.com/iot/latest/developerguide/managing-device-certs.html#server-authentication
 *RSA 2048 bit key
 */
static const char caPemCrt[] PROGREM = R"EOF(
 -----BEGIN CERTIFICATE-----
...
/*setup the serial connection and communication*/
void setup()
{
    ...
    /*get the current time, otherwise certs are flagged as expired*/
    setCurrentTime();
...
void loop()
{
    ...
    {
        String msg = String("Incoming Connect from ESP8266: ") + ++msgCount;
