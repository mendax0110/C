...
/*the main code for the programm*/
int main()
{
  int32_t res;
  ...
  /*this example dispatches aribtrary functions ro tun on the second core 
   * to do this we run a dispatcher on the second core thath accepts a function
   ...
   */
   ...
   /*We could now do a load of stuff in core 0 and get our result later*/
