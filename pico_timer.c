...
/*using struct as an example, but promitive types can be used too*/
...
int main()
{
    ...
    /*now retreieve all that are available periodically(simulate polling)*/
    for(int i = 0; i < 10; i++)
    {
